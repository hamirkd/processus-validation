...
@RestController
@RequestMapping("/demandes-employe")
@CrossOrigin("*")
public class DemandeEmployeController {
    ...
    public DemandeEmployeController(DemandeService service, DirectionService directionService, TemplateService<User, Long> userService) {
